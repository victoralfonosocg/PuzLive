...
public class NivelesDinamico extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.tvFacil:
			intent = new Intent(NivelesDinamico.this, FacilDinamico.class);
		...
		case R.id.tvMedio:
			...
			intent = new Intent(NivelesDinamico.this, MedioDinamico.class);
		...
		case R.id.tvDificil:
			...
			intent = new Intent(NivelesDinamico.this, DificilDinamico.class);
