...
public class JuegoDinamico extends SurfaceView implements SurfaceHolder.Callback,
	...
	public JuegoDinamico(Context context, int divx, int divy, Activity act) {
	...
	public void dibujarSeparaciones(Canvas canvas) {
		...
		for (int i = 1; i < divy; i++) {
			canvas.drawLine(0, (height / divy) * i, width, (height / divy) * i,
					myPaint);
		}
